...
window.addEventListener("load", () => {
    /* ---------------------- Page Loader ----------------------------- */
    document.querySelector(".page-loader").classList.add("slider-out-right");
    setTimeout(() => {
...
/* --------------------- Filter Portgolio Items -------------- ------ */
const filterBtnsContaniner = document.querySelector(".portfolio-filter");
let portfolioItems;
filterBtnsContaniner.addEventListener("click", (e) => {
    if(e.target.classList.contains("portfolio-filter-btn") && !e.target.classList.contains("active")){
        filterBtnsContaniner.querySelector(".active").classList.remove("active");
...
// Filter Active Category Porftolio Items
